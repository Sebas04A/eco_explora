  ...
  if (authError) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-100 text-center">
        ...
        <button onClick={() => router.push('/')} className="bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600">
          Volver al Inicio
        </button>
      </div>
    );
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav className="flex-1 p-2 space-y-2">
          <Link href="/admin/usuarios" className="flex items-center p-2 rounded hover:bg-gray-700">
            <Users className="mr-3 h-5 w-5" /> Gestionar Usuarios
          </Link>
          <Link href="/admin/plantas" className="flex items-center p-2 rounded hover:bg-gray-700">
            <Sprout className="mr-3 h-5 w-5" /> Gestionar Plantas
          </Link>
          <Link href="/admin/categorias" className="flex items-center p-2 rounded hover:bg-gray-700">
            <LayoutGrid className="mr-3 h-5 w-5" /> Gestionar Categorías
          </Link>
        </nav>
        <div className="p-2 border-t border-gray-700">
          <button onClick={handleLogout} className="w-full flex items-center p-2 rounded hover:bg-red-500">
