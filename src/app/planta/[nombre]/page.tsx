...
async function page(props: { params: Promise<{ nombre: string }> }) {
    ...
    return (
        <div className=' mx-auto mt-10 md:m-12 p-2  bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300'>
            <div className='p-4'>
                <img
                ...
                <div className='grid grid-cols-2 gap-4 my-6 sm:mx-6 text-sm text-gray-700  bg-green-50 p-4 rounded-lg'>
                    ...
                    <div>
                        <span className='font-semibold'>Veces consumida:</span>{' '}
                ...
                <div className='flex gap-6 w-full justify-end text-sm text-gray-500 '>
                    <div>
                        <span className='hidden sm:inline font-semibold'>Registrado por:</span>{' '}
                        {planta.UsuarioRegistro}
                    </div>
                    <div>
                        <span className='hidden sm:inline font-semibold'>Fecha de registro:</span>{' '}
